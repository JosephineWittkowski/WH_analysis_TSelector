...
void TSelector_SusyNtuple::fillHistos_SR6_EE(int mcid, float cut_EE, float weight_ALL_EE, float METrel, float HT, float mWWt, float mCT, TLorentzVector el1_TLV, TLorentzVector el2_TLV, const Met* susymet, Electron* el1, Electron* el2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
  ...
  h_mZTT_missMassCalc_SR6_EE->Fill(mZTT_missMassCalc, cut_EE, weight_ALL_EE); 
...
void TSelector_SusyNtuple::fillHistos_SR8_EE(int mcid, float cut_EE, float weight_ALL_EE, float METrel, float HT, float mWWt, float mCT, TLorentzVector el1_TLV, TLorentzVector el2_TLV, const Met* susymet, Electron* el1, Electron* el2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
  ...
  h_mZTT_missMassCalc_SR8_EE->Fill(mZTT_missMassCalc, cut_EE, weight_ALL_EE); 
...
void TSelector_SusyNtuple::fillHistos_SR6_MM(int mcid, float cut_MM, float weight_ALL_MM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu1_TLV, TLorentzVector mu2_TLV, const Met* susymet, Muon* mu1, Muon* mu2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
  ...
  h_mZTT_missMassCalc_SR6_MM->Fill(mZTT_missMassCalc, cut_MM, weight_ALL_MM); 
...
void TSelector_SusyNtuple::fillHistos_SR8_MM(int mcid, float cut_MM, float weight_ALL_MM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu1_TLV, TLorentzVector mu2_TLV, const Met* susymet, Muon* mu1, Muon* mu2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
...
//   cout << "mu1_TLV.Pt()= " <<  mu1_TLV.Pt() << " mu2_TLV.Pt()= " << mu2_TLV.Pt() << endl;
  ...
  h_mZTT_missMassCalc_SR8_MM->Fill(mZTT_missMassCalc, cut_MM, weight_ALL_MM); 
...
void TSelector_SusyNtuple::fillHistos_SR7_EM(int mcid, float cut_EM, float weight_ALL_EM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu_TLV, TLorentzVector el_TLV, const Met* susymet, Muon* mu, Electron* el, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
  ...
  h_mZTT_missMassCalc_SR7_EM->Fill(mZTT_missMassCalc, cut_EM, weight_ALL_EM); 
...
void TSelector_SusyNtuple::fillHistos_SR9_EM(int mcid, float cut_EM, float weight_ALL_EM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu_TLV, TLorentzVector el_TLV, const Met* susymet, Muon* mu, Electron* el, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc){
  ...
  h_mZTT_missMassCalc_SR9_EM->Fill(mZTT_missMassCalc, cut_EM, weight_ALL_EM); 
