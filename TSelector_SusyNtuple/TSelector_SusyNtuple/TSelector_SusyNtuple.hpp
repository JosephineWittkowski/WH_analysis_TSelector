...
//     TH1F* cutflow_MM_chargeFlipWeight;
    ...
    void fillHistos_SR6_MM(int mcid, float cut_MM, float weight_ALL_MM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu1_TLV, TLorentzVector mu2_TLV, const Met* susymet, Muon* mu1, Muon* mu2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc);
    
    void fillHistos_SR8_MM(int mcid, float cut_MM, float weight_ALL_MM, float METrel, float HT, float mWWt, float mCT, TLorentzVector mu1_TLV, TLorentzVector mu2_TLV, const Met* susymet, Muon* mu1, Muon* mu2, LeptonVector leptons, TLorentzVector signalJet1_TLV, TLorentzVector signalJet2_TLV, int nSignalJets, float mZTT_coll, float mZTT_mmc, float mZTT_missMassCalc);
